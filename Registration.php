...
<html lang="en">
 ...
 <style>
   body{
    background: url("https://images.pexels.com/photos/1028599/pexels-photo-1028599.jpeg") no-repeat;
    width: 100%;
    height: 100vh;
...
<form action="registration.php" method="post">
            ...
            <div class="group">
                <input type="password" class="form-control" name="repeat_password" placeholder="Re Enter Password" required>
            </div>
      ...
      <div class="already">
          <p>Go back to <a href="home.php">Home Page</a></p></div>
      </div>
    </div>
  </body>
</html>
